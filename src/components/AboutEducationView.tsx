    ...
    <div className='about-education-container'>
      {education && education.education.description && education.education.description.length > 0 && 
        <div key={education.id}>
          <div>
            <h4>Om utbildningen {education.education.title[0].content} ({education.education.code})</h4>
            <p>Id: {education.id}</p>
          ...
          <div>
            ...
            <p>Utbildningsperiod: {education.events[0].execution.start} - {education.events[0].execution.end}</p>
